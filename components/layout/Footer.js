...
const SOCIAL_LINKS = [
    { icon: Github, href: process.env.NEXT_PUBLIC_GITHUB_URL || 'https://github.com/Harshit1983', label: 'GitHub' },
    { icon: Linkedin, href: 'http://www.linkedin.com/in/harshit775/', label: 'LinkedIn' },
            ...
            <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 1.5rem' }}>
                ...
                <div style={{
                    ...
                    <div>
                        ...
                        <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem', lineHeight: 1.6, maxWidth: 220 }}>
                            Software Engineer building impactful digital experiences.
                        </p>
                    ...
                    <div>
                        ...
                        <a href="mailto:harshitpandiyar1983@gmail.com" style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', marginTop: '1rem', color: 'var(--text-secondary)', fontSize: '0.8rem', textDecoration: 'none' }}>
                            <Mail size={13} />
                            harshitpandiyar1983@gmail.com
                        </a>
                    </div>
                </div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '0.5rem' }}>
                    <p style={{ color: 'var(--text-muted)', fontSize: '0.8rem', display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
                        Made with <Heart size={12} style={{ color: 'var(--accent-violet)', fill: 'currentColor' }} /> by Harshit Pandiyar &ndash; &copy; {year}
                    </p>
                    {/* Admin login link */}
